...
#include "rs232_noInterrupt.h"												// Headerdatei für rs232_noInterrupt.c
...
//olatile unsigned char UART_RXBuffer[UART_BUFFER_SIZE];						// Ringpuffer- Array für empfangene	UART Daten, Größe UART_BUFFER_SIZE definiert in RS232.h
