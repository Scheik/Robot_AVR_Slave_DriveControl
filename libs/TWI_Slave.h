...
volatile uint8_t i2cdata[i2c_buffer_size];									// Der Buffer, in dem die Daten gespeichert werden. Aus Sicht des Masters l�uft der Zugrif auf den Buffer genau wie bei einem I2C-EEPROm ab. F�r den Slave ist es eine globale Variable
